...
E1001、E1002、E1003 都使用同一种卡片式提醒界面。E1003 一页最多显示 8 条；E1001 和 E1002 使用缩小版 4 卡片页面，字体和间距更小。每条卡片都包含：
...
E1003 可以点一下卡片左侧方框来标记完成。完成项会自动变灰，并下沉到列表底部，让未完成事项始终保持在视觉中心。E1001 和 E1002 没有触摸输入；当 4 条卡片页面已满时，下一次录音会覆盖当前可见提醒里提醒时间最早的那一条。
...
- 中文构建：`reterminal_e1001_zh`、`reterminal_e1002_zh`、`reterminal_e1003_zh`

中文构建会使用 OpenFontRender 渲染中文界面，并给 Whisper 发送中文语音识别提示。
...
| 设备 | 状态 | 说明 |
| --- | --- | --- |
| reTerminal E1001 | 支持 | 缩小版 4 卡片灰阶 UI，无触摸 |
| reTerminal E1002 | 支持 | 缩小版 4 卡片彩色 UI，无触摸 |
| reTerminal E1003 | 支持 | 8 卡片灰阶 UI，支持触摸勾选 |
| 中文固件 | 支持 | E1001 / E1002 / E1003，OpenFontRender + 内嵌中文字体 |
